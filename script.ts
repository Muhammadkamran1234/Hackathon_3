...
const mystartButton = document.getElementById("startButton") as HTMLButtonElement;
const mycontainer = document.getElementById("container") as HTMLDivElement;
const myopenButton = document.getElementById("openButton") as HTMLDivElement;


if (mystartButton && mycontainer ) {
  mystartButton.addEventListener("click", () => {
    myopenButton.style.display = "none";
